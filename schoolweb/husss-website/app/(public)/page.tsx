...
export default async function HomePage() {
  ...
  return (
    <div className="relative">
      ...
      <section className="relative bg-husss-green-950 text-white overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="grid lg:grid-cols-[1fr_1fr] gap-16 items-center">
            {/* LEFT: Content with premium staggered reveals */}
            <div className="relative z-10">
              <StaggeredReveal staggerDelay={100}>
                ...
                {/* Main Headline - Gradient shimmer */}
                  ...
                  <div className="mt-10 flex flex-wrap gap-4">
                    ...
                    <MagneticElement strength={0.4} scaleOnHover={1.05}>
                      <MagneticButton
                        ...
                        size="lg"
                        onClick={() => {}}
                        className="bg-transparent border-2 border-husss-gold-500 text-husss-gold-400 hover:bg-husss-gold-500/10"
                      >
            ...
            {/* RIGHT: Flagship Stat - 3D Diploma Seal */}
            {flagshipStat && (
                      ...
                      <div className="relative w-full h-full rounded-full bg-gradient-to-br from-husss-green-800 to-husss-green-950 flex flex-col items-center justify-center p-6">
                        ...
                        <div className="relative z-10 text-center">
                          <AnimatedCounter
                            ...
                            duration={2000}
                            delay={500}
                            className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-husss-gold-400 leading-none"
                          />
      ...
      {/* ============================================================
           QUICK HIGHLIGHTS - Animated stat cards with magnetic hover
           ============================================================ */}
          ...
          {[
            ...
            <ScrollReveal3D key={item.label} type="slide-up-3d" delay={index * 80}>
              <MagneticElement strength={0.3} scaleOnHover={1.04} rotateOnHover={true}>
                <ParallaxCard
                  className="card-hairline p-6 text-center h-full bg-white/80 backdrop-blur-sm border-husss-green-100 hover:border-husss-gold-300"
                  glow
      ...
      {/* ============================================================
           FEATURED ACCOMPLISHMENTS - 3D Cards with stagger
           ============================================================ */}
              ...
              {featuredAccomplishments.map((item, i) => (
                <ScrollReveal3D key={item.id} type="slide-up-3d" delay={i * 100}>
                  <MagneticElement strength={0.25} scaleOnHover={1.02} rotateOnHover={true}>
                    <ParallaxCard
                      className="card-hairline overflow-hidden h-full hover:shadow-2xl transition-all duration-700"
                      glow
                      glowColor="rgba(30, 123, 52, 0.3)"
                      maxTilt={6}
                    >
                      <div className="aspect-video bg-husss-green-50 relative overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4 right-4 flex justify-between">
                          <span className="text-xs font-medium text-husss-gold-400 bg-husss-green-950/80 backdrop-blur-sm px-3 py-1 rounded-full">
                            Recognition
                          </span>
                          {item.stat_value && (
                            <AnimatedCounter
                              ...
                              duration={1200}
                              className="font-display text-2xl font-bold text-husss-gold-400"
                            />
                          )}
                        </div>
                      </div>
                      <div className="p-6">
                        ...
                        {item.description_en && (
                          <p className="text-sm text-muted mt-2 line-clamp-3 leading-relaxed">{item.description_en}</p>
                        )}
                      </div>
                    </ParallaxCard>
                  </MagneticElement>
      ...
      {/* ============================================================
           LATEST NEWS - 3D Cards with hover reveal
           ============================================================ */}
                    ...
                    <ScrollReveal3D key={post.id} type="slide-up-3d" delay={i * 100}>
                      <MagneticElement strength={0.25} scaleOnHover={1.02} rotateOnHover={true}>
                        <Link href={`/news/${post.slug}`}>
                          <ParallaxCard
                            className="card-hairline overflow-hidden h-full bg-white hover:shadow-2xl transition-all duration-700"
                            glow
                            glowColor="rgba(245, 168, 0, 0.25)"
                            maxTilt={6}
                          >
                            ...
                            <div className="p-6">
                              ...
                              {post.excerpt_en && (
                                <p className="text-sm text-white/60 mt-3 line-clamp-2 leading-relaxed">{post.excerpt_en}</p>
                              )}
                            </div>
                          </ParallaxCard>
                        </Link>
      ...
      {/* ============================================================
           CTA SECTION - Full width with 3D background
           ============================================================ */}
          ...
          <StaggeredReveal staggerDelay={120}>
            ...
            <ScrollReveal3D type="flip-y" delay={300}>
              <div className="flex gap-4 justify-center flex-wrap">
                <MagneticElement strength={0.4} scaleOnHover={1.05}>
                  <MagneticButton variant="primary" size="lg" onClick={() => {}} className="group">
                ...
                <MagneticElement strength={0.4} scaleOnHover={1.05}>
                  <MagneticButton
                    ...
                    size="lg"
                    onClick={() => {}}
                    className="bg-husss-green-800 text-white hover:bg-husss-green-900 group"
                  >
